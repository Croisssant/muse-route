...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        python prompts_medium.py --backend ollama --model qwen3.6 --base-url http://127.0.0.1:11435
        ...
        python prompts_medium.py --tasks medium_01 medium_03

        # Combine layout and task filtering
        python prompts_medium.py --layout-mode list --layouts layout_15 layout_17 --tasks medium_01 medium_02
    ...
    parser.add_argument('--scar-fields', nargs='+',
                       default=['at_least_n_exhibits_coverage', 'exhibit_category_coverage', 'attribute_validations'],
    ...
    parser.add_argument('--tasks', nargs='+', type=str,
                       default=None,
                       help='Specific task/config variant(s) to process (e.g., medium_01 medium_03). Filters after discovering configs. (default: None, process all)')
...
def main():
    ...
    if args.tasks:
        ...
        for complexity, layout_folder, config_variant, config_path in layout_config_combos:
            ...
            # Support both "medium_01" and "medium_01.json" formats
